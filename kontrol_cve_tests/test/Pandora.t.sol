...
contract PandoraTest is Test, KontrolCheats {
    uint256 constant MAX_INT = 2**256 - 1;
    HumanStandardToken token; // Contract under test
	event Transfer(address indexed _from, address indexed _to, uint256 _value);

    function setUp() public {
        token = new HumanStandardToken(1000000, 'HumanStandardToken', 0, 'Pandora');
    }
